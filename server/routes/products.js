...
router.post("/product-by-price-range", productController.getProductByPriceRange);
router.post("/search-products", productController.searchProducts);
router.post("/search-and-filter-products", productController.searchAndFilterProducts);
